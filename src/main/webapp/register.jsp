    ...
    <div class="form">
        ...
        <form action="<%=request.getContextPath()%>/users" method="post">
          <div class="form-group">
            <label for="name">姓名</label> <input type="text" placeholder="例: 山田　太郎" id="name" name="name">
          </div>

          <div class="form-group">
            <label for="email">メールアドレス</label> <input type="email" placeholder="例: sample@example.com" id="email" name="email">
          </div>

          <div class="form-group">
            <label for="prefectureId">都道府県</label> 
            <select id="prefectureId" name="prefectureId" required>
            ...
            <div class="form-group" class="form-btn">
              <input type="submit" value="登録"> <a href="<%=request.getContextPath()%>/users" class="cancel-btn">キャンセル</a>
            </div>
        </form>
    </div>
</body>
